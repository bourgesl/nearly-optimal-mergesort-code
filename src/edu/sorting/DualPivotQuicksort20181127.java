 ...
 * @since 1.7 * 12
 */
public final class DualPivotQuicksort20181127 implements wildinter.net.mergesort.Sorter {

    public final static wildinter.net.mergesort.Sorter INSTANCE = new DualPivotQuicksort20181127();

    /**
     * Prevents instantiation.
     */
    private DualPivotQuicksort20181127() {
    }
...
//                }
     ...
     * @param high the index of the last element, exclusive, to be sorted
     */
    private static void pairInsertionSort(int[] a, int low, int end, int last) {
        /*
