 ...
 * @since 1.7 * 12
 */
public final class DualPivotQuicksort201811P implements wildinter.net.mergesort.Sorter {

    public final static wildinter.net.mergesort.Sorter INSTANCE = new DualPivotQuicksort201811P();

    /**
     * Prevents instantiation.
     */
    private DualPivotQuicksort201811P() {
    }
    ...
    private static void sort(Sorter sorter, int[] a, int bits, int low, int high) {
        while (true) {
             ...
             */
// LBO: disable heap sort on small sizes (2018.11.16):             
