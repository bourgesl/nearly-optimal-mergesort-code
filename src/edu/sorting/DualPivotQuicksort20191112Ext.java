 ...
 * @since 1.7 * 14
 */
public final class DualPivotQuicksort20191112Ext implements wildinter.net.mergesort.Sorter {

    public final static wildinter.net.mergesort.Sorter INSTANCE = new DualPivotQuicksort20191112Ext();
...
//  private DualPivotQuicksort() {}
     ...
     */
    private static void sort(Sorter sorter, int[] a, int[] b, int bits, int low, int high) {
        while (true) {
