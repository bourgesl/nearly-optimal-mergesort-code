...
# single-threaded:
java $JAVA_OPTS  -cp target/edu-sorting-bench.jar org.openjdk.jmh.Main ArrayXorBenchmark -gc $GC -wi $WITER -w $WTIME -i $ITER -r $TIME -f $FORK -t 1 -prof $PROF $OPTS 1> "xor-prof-${PROF}.log" 2> "xor-prof-${PROF}.err" 
